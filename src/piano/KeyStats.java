...
public interface KeyStats
{
	...
	int SPACE_BETWEEN_BLACK_KEYS = WHITE_WIDTH + SPACE_BETWEEN_WHITE_KEYS - BLACK_WIDTH;// FIRST_BLACK - (BLACK_WIDTH / 2);
	int BIG_SPACE_BETWEEN_BLACK_KEYS = 2 * (WHITE_WIDTH + SPACE_BETWEEN_WHITE_KEYS) - BLACK_WIDTH; // FIRST_BLACK * 2;
}
